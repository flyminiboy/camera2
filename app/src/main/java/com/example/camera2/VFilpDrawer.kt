...
//            GLES30.glUniform1i(mOESTextureLocation, 0) // TODO
    ...
    override fun bindTextureId(textureId: Int, surfaceTexture: SurfaceTexture) {
        init()
    ...
    private fun getFragmentShader(): String {
        ...
        return  "#version 300 es\n" +
                ...
                "out vec4 outColor;\n" +
                "void main() {\n" +
                "outColor = texture(uTexture, vec2(vCoordinate.x,1.0-vCoordinate.y));\n" +
                "}\n"
    }
